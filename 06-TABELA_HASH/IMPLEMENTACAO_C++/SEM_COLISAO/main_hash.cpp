/* Implementação de uma estrutura de dados do tipo Tabela Hash, sem tratamento de colisão, utilizando o método de endereçamento aberto. 

O programa tem como objetivo armazenar os dados de alunos, onde cada aluno tem um RA e um nome. O programa deve ser capaz de inserir, remover, buscar e imprimir os dados dos alunos na tabela hash. */
